...
pub mod types {
    ...
    impl InstructionData for Initialize {}
    ...
    impl InstructionData for InitializeTipDistributionAccount {}

    #[derive(AnchorSerialize, AnchorDeserialize)]
    pub struct CloseClaimStatus {}
    impl InstructionData for CloseClaimStatus {}
    ...
    impl InstructionData for UploadMerkleRoot {}

    #[derive(AnchorSerialize, AnchorDeserialize)]
    pub struct CloseTipDistributionAccount {
        pub _epoch: u64,
    }
    impl InstructionData for CloseTipDistributionAccount {}
    ...
    impl InstructionData for Claim {}

    // Account structs with manual ToAccountMetas implementations
    ...
    impl ToAccountMetas for InitializeAccounts {
    ...
    impl ToAccountMetas for InitializeTipDistributionAccountAccounts {
        fn to_account_metas(&self, _is_signer: Option<bool>) -> Vec<AccountMeta> {
            vec![
                AccountMeta::new_readonly(self.config, false),
                AccountMeta::new(self.tip_distribution_account, false),
                AccountMeta::new_readonly(self.system_program, false),
                AccountMeta::new_readonly(self.validator_vote_account, false),
    ...
    impl ToAccountMetas for CloseClaimStatusAccounts {
        fn to_account_metas(&self, _is_signer: Option<bool>) -> Vec<AccountMeta> {
            vec![
                AccountMeta::new_readonly(self.config, false),
                AccountMeta::new(self.claim_status, false),
                AccountMeta::new(self.claim_status_payer, false),
            ]
        }
    }
    ...
    impl ToAccountMetas for UpdateConfigAccounts {
        fn to_account_metas(&self, _is_signer: Option<bool>) -> Vec<AccountMeta> {
            vec![
                AccountMeta::new(self.config, false),
    ...
    impl ToAccountMetas for UploadMerkleRootAccounts {
        fn to_account_metas(&self, _is_signer: Option<bool>) -> Vec<AccountMeta> {
            vec![
                AccountMeta::new_readonly(self.config, false),
                AccountMeta::new(self.tip_distribution_account, false),
    ...
    impl ToAccountMetas for CloseTipDistributionAccountAccounts {
        fn to_account_metas(&self, _is_signer: Option<bool>) -> Vec<AccountMeta> {
            vec![
                AccountMeta::new_readonly(self.config, false),
                AccountMeta::new(self.tip_distribution_account, false),
                AccountMeta::new(self.validator_vote_account, false),
                AccountMeta::new(self.expired_funds_account, false),
                AccountMeta::new(self.signer, true),
            ]
        }
    }
    ...
    impl ToAccountMetas for ClaimAccounts {
        fn to_account_metas(&self, _is_signer: Option<bool>) -> Vec<AccountMeta> {
            vec![
                AccountMeta::new_readonly(self.config, false),
                AccountMeta::new(self.tip_distribution_account, false),
